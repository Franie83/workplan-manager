...
class EditUserForm(FlaskForm):
    ...
    confirm_password = PasswordField('Confirm Password', validators=[Optional(), EqualTo('password')])  # 🔥 ADD THIS LINE
    role = SelectField('Role', choices=[('User', 'User'), ('Admin', 'Admin'), ('Superadmin', 'Superadmin')], default='User')
...
def edit_user(user_id):
    ...
    form = EditUserForm(obj=user)  # Uses EditUserForm from previous message
